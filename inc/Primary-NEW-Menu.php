...
/*------------------------------------------------------------------
  Удаляем лишние class
-------------------------------------------------------------------*/

function my_css_attributes_filter( $var ) {
	$allow = array('uk-active');
...
class Primary_Walker_Nav_Menu extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		$output .= "\n$indent<div class=\"uk-navbar-dropdown\" uk-dropdown=\"offset: 0; delay-show: 50; delay-hide: 30; duration: 50;\">\n<ul role=\"menu\" class=\"uk-nav uk-navbar-dropdown-nav uk-list-divider\">\n";
	}
	/**
