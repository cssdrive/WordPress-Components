...
<!-- Кастомная страница втора -->
<?php function contributors() { global $wpdb; $authors = $wpdb->get_results("SELECT ID, user_nicename from $wpdb->users ORDER BY display_name"); foreach($authors as $author) {?>	
	<li>
		<div class="uk-card uk-card-default uk-card-small uk-card-body">
			<h2 class="uk-card-title"><?php the_author_meta('display_name', $author->ID);?></h2>
			<p class="uk-text-small"><?php the_author_meta('description', $author->ID);?></p>
			<a class="uk-button uk-button-primary" href="<?php get_bloginfo('url')?>/author/<?php the_author_meta('user_nicename', $author->ID);?>">Все статьи автора</a>
		</div>
	</li>
<?php }} ?>
<div uk-height-viewport="expand: true">
	<div class="single-analytics uk-section uk-section-small">
